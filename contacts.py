...
class Contact_book:
    ...
    def _header_index_entry(self):
        ...
        :return: словарь, где:
                ...
                - значение: словарь, где:
                    ...
                    - значение: значение соответствующего поля из всех записей
        '''
    ...
    def _dupl_dict(self, *fields):
        ...
        :return: словарь дублируюихся записей, где:
            - ключ: заголовок поля (элемент первой строки исходного файла),
            - значение: словарь, где:
                - значение: список индексов записей, имеющих одинаковое значение в поле, являющися ключом внешнего словаря
